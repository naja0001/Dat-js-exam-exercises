...
function filteredCourses() {
  ...
  if (selectValue === "5") {
    filteredCourse = courses.filter((course) => course.ectsPoints === 5);
  } else if (selectValue === "10") {
    filteredCourse = courses.filter((course) => course.ectsPoints === 10);
  } else if (selectValue === "15") {
    filteredCourse = courses.filter((course) => course.ectsPoints === 15);
  } else if (selectValue === "20") {
    filteredCourse = courses.filter((course) => course.ectsPoints === 20);
  } else {
